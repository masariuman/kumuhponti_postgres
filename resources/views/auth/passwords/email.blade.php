    ...
    <body>
        ...
        <div id="login-container">
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <!-- Login Form -->
                <form id="form-login" method="post" class="form-horizontal" action="{{ route('password.email') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group form-actions">
                        <div>
                            <button type="submit" class="btn btn-effect-ripple btn-sm btn-primary" style="width: 100%;"><i class="fa fa-arrow-right"></i> Kirim Alamat Reset Password ke Email</button>
