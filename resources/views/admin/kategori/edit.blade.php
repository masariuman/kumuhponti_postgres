	    	...
	    	<!-- Datatables Block -->
                        ...
                        <div class="block full">
                            ...
                            <div class="container-fluid" style="padding-top: 10px;">
                                ...
                                <form method="post" action="/admin/kategori/{{$datas->id}}">
                                {{csrf_field()}}
                                {{ method_field('PUT') }}
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="text" name="nama" class="form-control" maxlength="191" required="" value="{{$datas->nama}}">
                                    </div>
                                    <div class="form-group">
                                      <label class="control-label">Icon </label>
                                          <div class="input-group">
                                            ...
                                            <input id="thumbnail" class="form-control" type="text" name="icon" value="{{$datas->icon}}">
                                          </div>
                                          <div class="container-fluid">
                                            <center><img id="holder" style="margin-top:15px;max-height:100px;" src="{{$datas->icon}}"></center>
                                          </div>
                                    </div>      
                                    <div class="form-group">
                                      <label class="control-label">Icon Expired </label>
                                          <div class="input-group">
                                            ...
                                            <input id="thumbnail1" class="form-control" type="text" name="icon_ex" value="{{$datas->icon_ex}}">
                                          </div>
                                          <div class="container-fluid">
                                            <center><img id="holder1" style="margin-top:15px;max-height:100px;" src="{{$datas->icon_ex}}"></center>
                                          </div>
                                    </div>
                                    <div class="form-group">
